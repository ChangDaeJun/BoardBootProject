...
class CommentDeleteServiceTest {
    ...
    @Test
    void deleteById() {
        boolean before = commentRepository.existsById(this.commentId);
        commentDeleteService.deleteById(this.commentId);
        boolean after = commentRepository.existsById(this.commentId);
    ...
    void deleteByUserId() {
        boolean before = commentRepository.existsById(this.commentId);
        commentDeleteService.deleteByUserId(this.userId);
        boolean after = commentRepository.existsById(this.commentId);
    ...
    void deleteByBoardId() {
        boolean before = commentRepository.existsById(this.commentId);
        commentDeleteService.deleteByBoardId(this.boardId);
        boolean after = commentRepository.existsById(this.commentId);
